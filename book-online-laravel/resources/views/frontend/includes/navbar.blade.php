            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarCenteredExample">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0 px-5">
                    ...
                    <li class="nav-item dropdown position-static fw-bold">
                        ...
                        <!-- Dropdown menu -->
                        <div class="dropdown-menu w-100 mt-0" aria-labelledby="navbarDropdown" style="border-top-left-radius: 0; border-top-right-radius: 0; border:5px solid darkcyan">
                            <div class="container">
                                ...
                                <div class="row my-4">
                                    ...
                                    <div class="col-md-6 col-lg-3 mb-3 mb-lg-0">
                                        <div class="list-group list-group-flush genre-link">
                                            <a href="{{route('home.genre',[$genre->genre_slug])}}" 
                                            class="list-group-item list-group-item-action border-bottom border-2 title small">{{$genre->genre_name}}
                                        </a>
                                        </div>
                                    </div>
                                    @endforeach
                    ...
                    <li class="nav-item fw-bold">
                        <a class="nav-link text-white" href="#"><i class="fa-solid fa-list"></i> Top Sách</a>
                    </li>
                </ul>
                <!-- Left links -->
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // var links = document.querySelectorAll('.genre-link a');

        // links.forEach(function(link) {
        //     if (link.getAttribute('href') === window.location.href) {
        //         link.classList.add('genre-active');
        //     }
        // });
    });
</script>