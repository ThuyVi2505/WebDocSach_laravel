    ...
    <div class="row">
        <div class="col-12 col-lg-9">
                ...
                <div class="card-header pb-0 pt-2 border-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Thể loại:<span class="ms-2 text-dark fw-normal">{{$current_genre->genre_name}}</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
            <!-- tieu de -->
            <div class="my-2 border-0 text-start">
                <div class="pb-0 pt-2 border-0 bg-white ms-3">
                    <h5 class="fw-bold" style="color:darkcyan;"><span class="me-2 text-dark fw-normal">Sách theo thể loại:</span>{{$current_genre->genre_name}}</h5>
                </div>
            </div>
            ...
            <div class="album my-3">
                <div class="container">
                    @if($book_with_genre->count()==0)
                    <div class="d-flex align-items-center mb-2 ms-3">
                        <p class="text-decoration-none">Không có sách nào thuộc thể loại này...</p>
                    </div>
                    @endif
                    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 g-3">
                        @foreach($book_with_genre as $value => $book)
        ...
        <!-- Danh sách Thể loại -->
        <div class="col-12 col-lg-3 pt-3 pt-lg-0 d-lg-flex d-none">
            @include('frontend.includes.genre_list')
        </div>
        <!-- Danh sách thể loại -->
    </div>
</div>
