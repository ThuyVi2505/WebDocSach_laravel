...
<body>
    ...
    <div class="login-form">
        <form action="{{ route('login') }}" method="POST">
            ...
            <h4 class="modal-title my-3" style="color:darkcyan;">Welcome to Book Online!!!</h4>
            ...
            <div class="form-group small clearfix">
                <label class="form-check-label" for="remember"><input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}> Ghi nhớ</label>
