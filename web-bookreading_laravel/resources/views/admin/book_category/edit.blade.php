...
<div class="container-fluid px-4">
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/update_book_category/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <!-- input category -->
                    ...
                    <div class="form-group col-lg-4 col-md-12 col-sm-12">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select @error('category_state') is-invalid @enderror" name="category_state" id="category_state">
                                ...
                                <option value="1" {{ ($category->category_state == 1) ? 'selected' : '' }}>Có</option>
                                <option value="0" {{ ($category->category_state == 0) ? 'selected' : '' }}>Không</option>
                            </select>
                ...
                <div class="form-group">
                    <button type="submit" name="create_book_category" class="btn btn-success "><i class="fa-solid fa-check"></i> Cập nhật</button>
                </div>
            </form>
        </div>
    </div>
