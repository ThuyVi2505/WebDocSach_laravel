...
<div class="container-fluid px-4">
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form action="{{ url('admin/create_author') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    <!-- input name -->
                    ...
                    <!-- input status -->
                    <div class="form-group col-lg-4 col-md-12 col-sm-12">
                        <label for="author_status" class="form-label fw-bold">Trạng thái<span class="text-danger">*</span></label>
                        <div class="input-group">
                ...
                <div class="form-group">
                    <button type="submit" name="create_author" class="btn btn-success "><i class="fa-solid fa-check"></i> Lưu thông tin</button>
                </div>
            </form>
        </div>
    </div>
