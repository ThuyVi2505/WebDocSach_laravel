    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <!-- menu book_category -->
                <a class="nav-link collapsed text-warning" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ url('admin/book_category') }}">
                            <div class="sb-nav-link-icon"><i class="fa-solid fa-clipboard-list text-success"></i></div>
                            Xem Danh sách
                        </a>
                        <a class="nav-link" href="{{ url('admin/create_book_category') }}">
