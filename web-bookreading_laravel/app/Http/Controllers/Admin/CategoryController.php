...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate(
            [
                'category_name' => ['required', 'max:255', 'min:5', 'unique:category'],
                'category_slug' => [''],
            ...
            [
                ...
                'category_status.required' => 'Trạng thái chưa được chọn',
        ...
        return redirect('admin/create_category')->with('message', 'Thêm thành công');
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate(
            [
                'category_name' => ['required', 'max:255', 'min:5', 'unique:category,category_name,' . $id],
                'category_slug' => [''],
                'category_description' => [''],
                'category_status' => ['required'],
                'category_image' => ['mimes:jpeg,png,jpg,gif,svg', 'image']
        ...
        return redirect('admin/edit_category/' . $id)->with('message', 'Cập nhật thành công');
    }
    ...
    public function destroy($id)
    {
        ...
        // return response()->redirect()->route('book_category.index');
    }
    # GET - change status
